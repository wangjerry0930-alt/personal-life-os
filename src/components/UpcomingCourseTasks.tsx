...
export default function UpcomingCourseTasks({ toggleTask, onStartTimer }: { toggleTask: (id: string) => void; onStartTimer?: (task: { id: string; title: string; description?: string }) => void }) {
