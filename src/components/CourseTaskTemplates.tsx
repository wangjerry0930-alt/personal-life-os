...
export default function CourseTaskTemplates() {
  ...
  const visibleCourseTasks = courseFilter === 'All courses' ? courseTasks : courseTasks.filter(task => task.notes?.split(' · ')[1] === courseFilter);
