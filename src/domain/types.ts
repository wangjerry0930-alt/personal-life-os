...
export interface Task{id:string;title:string;description:string;minutes:number;difficulty:'Easy'|'Medium'|'Hard';category:'Daily progress'|'Habit'|'Manual';source?:'manual'|'quest'|'habit'|'knowledge';questId?:string;habitId?:string;areaId?:string;skillId?:string;projectId?:string;bookId?:string;conceptId?:string;goalId?:string;priority?:Priority;notes?:string;status:TaskStatus;completedAt?:string}
