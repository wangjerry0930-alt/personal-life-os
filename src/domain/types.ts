...
export interface Task{id:string;title:string;description:string;minutes:number;difficulty:'Easy'|'Medium'|'Hard';category:'Daily progress'|'Habit'|'Manual';areaId?:string;skillId?:string;projectId?:string;priority?:Priority;notes?:string;status:TaskStatus;completedAt?:string}
