...
export interface TimeEntry extends BaseEntity{title:string;category:string;taskId?:string;projectId?:string;areaId?:string;skillId?:string;startedAt:string;endedAt:string;durationMinutes:number;source:TimeEntrySource;notes?:string}
