...
export type Book={id:string;title:string;author:string;fileName:string;uploadedAt:string;status:'Ready'|'Processing';progress:number;areaId?:string;skillId?:string;chapters:string[];chunks:number;summary:string;concepts:BookConcept[];recalls:BookRecall[];sessions:BookSession[]};
